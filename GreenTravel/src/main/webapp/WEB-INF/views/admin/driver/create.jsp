...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Driver/</span> Create Driver</h4>
    <!-- Basic Layout -->
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                    ...
                    <form:form action="" method="post" modelAttribute="driver" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="file" name="img" class="form-control" required="true" id="basic-default-avt" />
                                </div>                      
