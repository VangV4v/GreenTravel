...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Customer/</span> Create Customer</h4>
    <!-- Basic Layout -->
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form:form action="" method="post" modelAttribute="cus" >
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="dateOfBirth" cssClass="form-control" id="basic-default-dateOfBirth" type="date" required="required"   />
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="phone" cssClass="form-control" id="basic-default-phone"   />
