...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Flight/</span> Create Flight</h4>
    <!-- Basic Layout -->
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                   <form:form action="" method="post" modelAttribute="flight" >
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-username">Flight(<sup style="color:red">*</sup>)</label>
